...
<head>
    ...
    <title>News Archives - ${settings.user_name!'Academic Homepage'}</title>
                ...
                <div class="hidden lg:block">
                    <div class="ml-10 flex items-center space-x-8">
                        <ul class="nav-links flex space-x-8">
                            ...
                            <li><a href="${context!}/archives" class="nav-item active">News</a></li>
    ...
    <main class="min-h-screen pt-20 lg:pt-28 pb-12">
        <div class="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="section-header mb-8">
                <h1 class="text-4xl font-serif font-bold text-primary">🔥 All News</h1>
                <p class="text-neutral-500 mt-2">Latest updates and announcements</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <#else>
                    <div class="text-center py-12">
                        <p class="text-neutral-500">暂无新闻 / No news yet</p>
                    </div>
                </#if>
            </div>
